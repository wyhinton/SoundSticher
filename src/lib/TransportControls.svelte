<script lang="ts">
  ...
  import TimeDisplay from './PlaybackDisplay/TimeDisplay.svelte';
...
<div class="info-panel d-flex justify-content-between align-items-center px-2 py-1">
  <div class="d-flex gap-3 align-items-center">
    ...
    <div class="info-item">
      ...
      <span class="info-value" class:skeleton={$appState.isCombiningFile}>
        {$appState.combinedFileLength
          ? formatMilliseconds($appState.combinedFileLength)
          : '0:00.000'}
      </span>
    </div>
